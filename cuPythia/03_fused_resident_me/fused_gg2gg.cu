...
__host__ __device__ inline double gg2gg_sigma(double sH, double tH, double uH, double alpS) {
  // reciprocal precompute: 3 FP64 divisions instead of 13 (~2.9x faster on Blackwell,
  // result identical to ~2e-15; FP64 division is ~1/64 rate and nvcc will not rewrite a/b -> a*(1/b)).
